...
`find` launches an interactive terminal UI to browse Workbench by disease and export a selection manifest of `analysis_id`s.
...
- `--fetch-targeted-data` (off by default; fetches study-level named-metabolite matrices for targeted/meta-analysis)
