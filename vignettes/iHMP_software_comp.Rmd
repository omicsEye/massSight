...
The `mass_combine()` function allows users to combine two datasets via the modeling of RT and m/z drift between the two experiments. For more information on the function, check out its [documentation](https://omicseye.github.io/massSight/reference/mass_combine.html)!
...
## Run mass_combine with dbscan

```{r, cache = T, eval = T}
aligned_c18 <- mass_combine(
  ms1 = ref_C18,
  ms2 = ms_C18_CD,
  smooth_method = "gam",
  log = NULL
