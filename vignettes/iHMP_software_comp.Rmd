...
For this tutorial, we will be analyzing two datasets from the NIH human microbiome project that were processed using different techniques. We provide a function (`load_ihmp_data()`) that automatically loads the two dataframes into your global environment, but they can also be downloaded manually. The first dataset can be downloaded [here](https://gwu.box.com/shared/static/u5b2djx2sf1tq6gy3twz0x4hno1r4o58.xlsx). The second dataset can be downloaded [here](https://gwu.box.com/s/hrgfgmlllvzvmzbzyn8tolygel9brkkz). 
...
We can then load the necessary libraries and iHMP datasets.
