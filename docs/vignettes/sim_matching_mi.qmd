...
print(f"Top1: P={prec:.3f} R={rec:.3f} F1={f1:.3f}  (TP={tp}/{len(labels)})")
...
mn, mx = mi2["true_logFC"].min(), mi2["true_logFC"].max()
...
- Matching uses ppm and RT windows (no drift correction here); probabilities are out‑of‑fold calibrated.
- MI uses randomized global 1–1 sampling (Gumbel‑perturbed Hungarian) and Rubin’s rules.
## Notes
