...
Alignment is performed using `mass_combine()`. This function uses a random search to optimize the alignment parameters.
...
More information on the `mass_combine()` function can be found in the [package documentation](https://omicseye.github.io/massSight/reference/mass_combine.html)
