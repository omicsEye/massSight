...
@app.command()
def combine(
    ms1_path: Annotated[Path, typer.Argument(help="Path to the first mass spec file (.csv or .tsv)")],
    ms2_path: Annotated[Path, typer.Argument(help="Path to the second mass spec file (.csv or .tsv)")],
    output_path: Annotated[Path, typer.Option(help="Path to save the combined file.")] = "combined.csv",
):
    """
